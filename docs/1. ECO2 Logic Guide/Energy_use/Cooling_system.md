# 3.2. 냉방 에너지소요량 (Energy use for cooling system)
...
### 3.2.1.1. 공조기기 냉열 에너지 요구량(\(Q_{c*,b}\))
...
### 3.2.3.2. 실내냉방 시스템 에너지 공급량(\(Q_{c,outg}\)) 
...
### 3.2.4.1. 수냉식 증기압축 냉동기(Water-cooled chiller)
...
### 3.2.4.2. 공랭식 증기압축 냉동기(Air-cooled chiller)
**- 제어 방식**: 특성치-방법에서는 다음 표에서 제시된 압축기 유형 및 제어 방식을 고려합니다.
<center>
...
### 3.2.4.3. 공랭식 실내냉방시스템(Air-cooled room air conditioning system)
